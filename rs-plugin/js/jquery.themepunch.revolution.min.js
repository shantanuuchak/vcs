...
(function (e, t) {
  ...
  function N(n, r) {
    ...
    if (l == 12 || l == 13 || l == 14 || l == 15) {
      ...
      TweenLite.fromTo(
        j,
        X,
        { left: F, top: I, scale: U, opacity: q, rotation: r.rotate },
        {
          opacity: 1,
          rotation: 0,
          left: 0,
  ...
  function B(n, r, i) {
    ...
    if (
      ...
      n.hasClass("stt") ||
      n.hasClass("stb") ||
      n.hasClass("skewtoright") ||
      n.hasClass("skewtorightshort") ||
        ...
        if (!u.hasClass("revslider-initialised")) {
          ...
          u.find(".tp-caption iframe").each(function (t) {
            try {
              if (e(this).attr("src").indexOf("vim") > 0 && S == 0) {
                S = 1;
                var n = document.createElement("script");
                n.src = "https://a.vimeocdn.com/js/froogaloop2.min.js";
                var r = document.getElementsByTagName("script")[0];
                var i = true;
                e("head")
                  .find("*")
          ...
          if (o.shuffle == "on") {
            for (var N = 0; N < u.find(">ul:first-child >li").length; N++) {
              ...
              u.find(">ul:first-child >li:eq(" + C + ")").prependTo(
