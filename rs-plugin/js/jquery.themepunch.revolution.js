...
(function (jQuery, undefined) {
      ...
      return this.each(function () {
        ...
        if (!container.hasClass("revslider-initialised")) {
          ...
          container.find(".tp-caption iframe").each(function (i) {
            try {
              if (jQuery(this).attr("src").indexOf("you") > 0 && addedyt == 0) {
                ...
                s.src =
                  "https://www.youtube.com/player_api"; /* Load Player API*/
          ...
          container.find(".tp-caption iframe").each(function (i) {
            try {
              if (
                jQuery(this).attr("src").indexOf("vim") > 0 &&
                addedvim == 0
              ) {
                addedvim = 1;
                var f = document.createElement("script");
                f.src =
                  "https://a.vimeocdn.com/js/froogaloop2.min.js"; /* Load Player API*/
                var before = document.getElementsByTagName("script")[0];
          ...
          if (opt.shuffle == "on") {
            for (
              var u = 0;
              u < container.find(">ul:first-child >li").length;
              u++
            ) {
              var it = Math.round(
  ...
  function createThumbs(container, opt) {
    ...
    container.find(">ul:first >li").each(function (i) {
      ...
      bullets.append(
        '<div class="bullet thumb" style="width:' +
          opt.thumbWidth +
          "px;height:" +
          opt.thumbHeight +
          'px;"><img src="' +
  ...
  function setBulPos(container, opt) {
    ...
    if (
      ...
      if (opt.soloArrowLeftHalign == "left")
        tl.css({ left: 0 + opt.soloArrowLeftHOffset + loff + "px" });
      if (opt.soloArrowLeftHalign == "right")
        tl.css({ right: 0 + opt.soloArrowLeftHOffset - loff + "px" });
      ...
      if (opt.soloArrowRightHalign == "left")
        tr.css({ left: 0 + opt.soloArrowRightHOffset + loff + "px" });
      if (opt.soloArrowRightHalign == "right")
        tr.css({ right: 0 + opt.soloArrowRightHOffset - loff + "px" });
    ...
    nextli.find(".tp-caption").each(function (i) {
      ...
      if (handlecaption == 0) {
            ...
            nextcaption.find("video").each(function (i) {
              ...
              if (html5vid.hasClass("video-js")) {
                ...
                if (!html5vid.hasClass("HasListener")) {
                  ...
                  var videoID =
                    "videoid_" + Math.round(Math.random() * 1000 + 1);
        ...
        if (
          ...
          nextcaption.data(
            "x",
            (crw / 2 - nextcaption.outerWidth(true) / 2) / xbw + hofs
          );
        }
        ...
        if (
          ...
          nextcaption.data(
            "y",
            (crh / 2 - nextcaption.outerHeight(true) / 2) / xbh + vofs
          );
        }
        ...
        if (nextcaption.hasClass("lft")) tlyy = -25 - imh;

        if (nextcaption.hasClass("lfb")) tlyy = 25 + opt.height;

        if (nextcaption.hasClass("sft")) tlyy = calcy - 50;

        if (nextcaption.hasClass("sfb")) tlyy = calcy + 50;
  ...
  function endMoveCaption(nextcaption, opt, mdelay) {
    ...
    if (
      ...
      if (nextcaption.hasClass("skewtorightshort")) xx = xx + 220;

      if (nextcaption.hasClass("skewtoleftshort")) xx = xx - 220;

      nextcaption.data(
        "outanim",
        TweenLite.to(nextcaption, mspeed, {
          left: xx,
          top: yy,
          scale: 1,
          rotation: 0,
